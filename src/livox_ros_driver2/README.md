...
* **[launch file]** : is the ROS launch file you want to use; the 'launch' folder contains the ROS1 launch samples shipped with this package.  
...
Launch files of ROS are in the "ws_livox/src/livox_ros_driver2/launch" directory. Different launch files have different configuration parameter values and are used in different scenarios:
